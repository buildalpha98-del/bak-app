...
export default function ImpactError({
  ...
  useEffect(() => {
    if (process.env.NODE_ENV !== "production") {
      console.warn("[dev] Impact dashboard error:", error.message);
    }
  }, [error]);
    ...
    <div className="flex items-center justify-center py-16 px-4">
      <div className="text-center max-w-sm">
        ...
        <p className="text-sm text-muted-foreground mb-6">
          Something went wrong loading the impact dashboard. Please try again or
          contact your Build Alpha Kids representative.
        </p>
        <button
          onClick={reset}
